...
Xtrain, Xtest , Ytrain, Ytest = train_test_split(norm_feat,targ_value,test_size=0.2,random_state=42)
...
print("The initial accuracy with 80-20 percentage spilt")
print(acc)
...
print("Initial accuracy with K fold method")
print(result.mean())
...
print("Accuracy after feature reduction")
print(accR)
...
clf_hyp.fit(XtrainR, YtrainR)
clf_pred=clf_hyp.predict(XtestR)

clf_hyp_acc=accuracy_score(YtestR,clf_pred)
